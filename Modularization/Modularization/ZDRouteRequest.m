...
@interface ZDRouteRequest ()

@property (nonatomic, copy) NSURL *URL;
@property (nonatomic, strong) NSArray *pathComponents;
@property (nonatomic, strong) NSDictionary *queryParams;
@property (nonatomic, assign) ZDRouteRequestOptions options;
@property (nonatomic, copy) NSDictionary *additionalParameters;

@end


@implementation ZDRouteRequest

- (instancetype)initWithURL:(NSURL *)URL options:(ZDRouteRequestOptions)options additionalParameters:(nullable NSDictionary *)additionalParameters
{
    if ((self = [super init])) {
        self.URL = URL;
        ...
        BOOL treatsHostAsPathComponent = ((options & ZDRouteRequestOptionTreatHostAsPathComponent) == ZDRouteRequestOptionTreatHostAsPathComponent);
